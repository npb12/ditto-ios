...
@interface TFHeartAnimationView ()
@property (strong, nonatomic) IBOutlet UIImageView *fixedHeart;
@property (strong, nonatomic) IBOutlet UIImageView *heartOne;
@property (strong, nonatomic) IBOutlet UIImageView *heartTwo;
@property (strong, nonatomic) IBOutlet UIImageView *heartThree;
@property (nonatomic, copy) void (^blocksCompletionHandler)(void);

@end

@implementation TFHeartAnimationView
