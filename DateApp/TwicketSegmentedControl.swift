...
@objc open class TwicketSegmentedControl: UIControl {
    ...
    @objc class SliderView: UIView {
        ...
        var cornerRadius: CGFloat! {
            didSet {
                ...
                sliderMaskView.layer.borderColor = UIColor.groupTableViewBackground.cgColor
                sliderMaskView.layer.borderWidth = 1;
    ...
    @objc open weak var delegate: TwicketSegmentedControlDelegate?
    ...
    @objc open func setSegmentItems(_ segments: [String]) {
