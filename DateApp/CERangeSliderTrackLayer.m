...
{
    // clip
    float cornerRadius = 0;//self.bounds.size.height * self.slider.curvatiousness / 2.0;
    ...
    // shadow
    CGContextSetShadowWithColor(ctx, CGSizeMake(0, 2.0), 3.0, [UIColor lightGrayColor].CGColor);
    CGContextAddPath(ctx, switchOutline.CGPath);
