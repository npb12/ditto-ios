...
@objc public class UIImageCropper: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    
    /// Aspect ratio of the cropped image
    public var cropRatio: CGFloat = 1
    /// delegate that implements UIImageCropperProtocol
    @objc var delegate: UIImageCropperProtocol?
    /// UIImagePickerController picker
    @objc public var picker: UIImagePickerController? {
        didSet {
    ...
    /// Crop button text
    @objc public var cropButtonText: String = "Done"
    /// Retake/Cancel button text
    @objc public var cancelButtonText: String = "Cancel"
    ...
    /// cropped image
    @objc public var cropImage: UIImage? {
        return crop()
    }
    ...
    @objc func getPicker() -> UIImagePickerController
    {
        return picker!;
    }
